...
const POSTER_ITEMS = [
  ...posterSet('Dream Destination', 'Dream Destination', [
    'Dream_Destination  (1).png',
    'Dream_Destination  (2).png',
    'Dream_Destination  (3).png',
  ]),
  ...posterSet('Globex', 'Globex', ['globex 01.png', 'globex 02.png', 'globex 03.png']),
  ...posterSet('Imperium Spaces', 'Imperium Spaces', [
    'Imperium Spaces (1).png',
    'Imperium Spaces (2).png',
    'Imperium Spaces (3).png',
    'Imperium Spaces (4).png',
  ]),
  ...posterSet('Lifespace', 'Lifespace Interiors', [
    'Lifespace Interiors (1).png',
    'Lifespace Interiors (2).png',
    'Lifespace Interiors (3).png',
    'Lifespace Interiors (4).png',
    'Lifespace Interiors (5).png',
  ]),
  ...posterSet('Medicohut', 'Medicohut', ['Medicohut-01.png', 'Medicohut-02.png']),
  ...
  ...posterSet('Sarogana', 'Sarogana', ['Sarogana 01.png', 'Sarogana 02.png', 'Sarogana 03.png']),
  ...posterSet('Souvenirs of India', 'Souvenirs of India', [
    'Souvenirs of India -01.png',
    'Souvenirs of India -02.png',
    'Souvenirs of India -03.png',
  ]),
  ...posterSet('Vscrapit', 'Vscrapit', ['vscrapit  (1).png', 'vscrapit (2).png']),
]

const CAROUSEL_ITEMS = [
  carousel('Honey.png', 'Raw honey', 4, 'KG Organic'),
  carousel('organic ghee.png', 'Ghee, step by step', 4, 'KG Organic'),
  carousel('organic jaggery.png', 'Organic jaggery', 4, 'KG Organic'),
  carousel('turmeric powder (1).png', 'Turmeric powder', 4, 'KG Organic'),
  carousel('memon_s.png', "Memon's", 4, 'Women clothing'),
  carousel('COORG.jpg', 'Coorg', 6),
  carousel('chardam carousal.jpg', 'Chardam', 5),
  carousel('Gokarna carousal.png', 'Gokarna', 4),
  carousel('skandagiri carousal.png', 'Skandagiri', 5),
]

const MOTION_ITEMS = [
  reel('Neuvoke 1', MOTION_DIR, 'neuvoke 1.mp4', 'neuvoke_1.jpg'),
  reel('Neuvoke 4', MOTION_DIR, 'neuvoke 4_revised.mp4', 'neuvoke_4_revised.jpg'),
  reel('Neuvoke 5', MOTION_DIR, 'neuvoke 5.mp4', 'neuvoke_5.jpg'),
  reel('Digital marketing reel', MOTION_DIR, 'digital marketing revised 2.mp4', 'digital_marketing_revised_2.jpg'),
]

const VIDEO_ITEMS = [
  reel('Jaguar Fitness', VIDEO_DIR, 'jaguar fitness.mp4', 'jaguar_fitness.jpg'),
  reel('Meraki Aesthetics 7', VIDEO_DIR, 'meraki aesthetics 7 revision 2.mp4', 'meraki_aesthetics_7_revision_2.jpg'),
  reel('Meraki Aesthetics 8', VIDEO_DIR, 'meraki aesthetics 8 (1).mp4', 'meraki_aesthetics_8_1.jpg'),
  reel('Lilac Workshop', VIDEO_DIR, 'lilac-workshop.mp4', 'lilac-workshop.jpg'),
  reel('Launch product', VIDEO_DIR, 'launch product. 1.mp4', 'launch_product._1.jpg'),
  reel('Giveaway', VIDEO_DIR, 'give away-1.mp4', 'give_away-1.jpg'),
  reel('Ad copy 2', VIDEO_DIR, 'ad copy 2.mp4', 'ad_copy_2.jpg'),
  reel('Pretty Shimmiring Reel 2', VIDEO_DIR, 'Pretty Shimmiring Reel 2  (1).mp4', 'Pretty_Shimmiring_Reel_2_1.jpg'),
  reel('TWM GM Collections', VIDEO_DIR, 'TWM GM collections.mp4', 'TWM_GM_collections.jpg'),
]
